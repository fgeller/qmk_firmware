...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_LSFT, KC_LSFT, KC_Z,    KC_X,    KC_M,   KC_C,   KC_V,    KC_K,  KC_L,  KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_NO, KC_NO,
		KC_LCTL, KC_LALT, KC_LGUI, KC_BSPC, MO(1),  KC_SPC, KC_RGUI, MT(MOD_RALT, KC_LEFT), KC_DOWN, KC_UP, KC_RIGHT),
