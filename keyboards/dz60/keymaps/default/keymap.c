...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		MT(MOD_LCTL, KC_BSPC), KC_A,    KC_S,    KC_H,    KC_T,   KC_G,   KC_Y,    KC_N,  KC_E,  KC_O,    KC_I, KC_QUOT, MT(MOD_RCTL, KC_ENT),
		KC_LSFT, KC_LSFT, KC_Z,    KC_X,    KC_M,   KC_C,   KC_V,    KC_K,  KC_L,  KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_RSFT, KC_RSFT,
		KC_LCTL, KC_LALT, KC_LGUI, MO(1), KC_ENT,  KC_SPC, KC_RGUI, MT(MOD_RALT, KC_LEFT), KC_DOWN, KC_UP, KC_RIGHT),
